...
<head>
  ...
  <title>DSgallery: cart_payment</title>
      ...
      <div style="width:100%;max-width:500px">
        ...
        <div id="card-fields">
          <div class="mb-3">
            ...
            <input class="form-control" type="text" placeholder="Willem Dafoe"/>
          </div>
          <div class="mb-3">
        ...
        <a class="btn btn-dark w-100 py-2" href="{{ route('home') }}" style="font-size:15px">Confirm payment: 4 579€</a>
