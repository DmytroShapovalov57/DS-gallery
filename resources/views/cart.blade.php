...
<body class="d-flex flex-column" style="min-height:100vh">
  ...
  <div class="d-flex flex-grow-1">
    ...
    <main class="p-4 flex-grow-1" style="min-width:0;overflow-y:auto">
      ...
      <div class="row gx-3 align-items-center py-3 border-bottom">
        <div class="col-auto col-md-1">
          <img class="cart-img" src="{{ asset('images/art/van_gogh/Fishing_in_the_Spring.jpg') }}" alt=""/>
        </div>
        <div class="col col-md-5">
          <h2>Fishing in the Spring</h2>
        </div>
        <div class="col-auto col-md-3">
          <div class="qty-control">
            <button class="qty-btn">−</button>
      ...
      <div class="row gx-3 align-items-center py-3 border-bottom">
        <div class="col-auto col-md-1">
          <img class="cart-img" src="{{ asset('images/art/van_gogh/Fritillaries_in_a_Copper_Vase.jpg') }}" alt=""/>
        </div>
        <div class="col col-md-5">
          <h2>Fritillaries in a Copper Vase</h2>
        </div>
        <div class="col-auto col-md-3">
          <div class="qty-control">
            <button class="qty-btn">−</button>
      ...
      <div class="row gx-3 align-items-center py-3">
        <div class="col-auto col-md-1">
          <img class="cart-img" src="{{ asset('images/art/van_gogh/Interior_of_a_Restaurant.jpg') }}" alt=""/>
        </div>
        <div class="col col-md-5">
          <h2>Interior of a Restaurant</h2>
        </div>
        <div class="col-auto col-md-3">
          <div class="qty-control">
            <button class="qty-btn">−</button>
      ...
      <div class="mt-4 border-top pt-3">
        <div class="d-flex justify-content-end mb-4 mt-1">
          <span style="font-size:22px;font-weight:500;font-family:var(--font-body)">4 579€</span>
        </div>
