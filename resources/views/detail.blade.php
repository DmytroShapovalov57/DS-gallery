...
<body class="d-flex flex-column" style="min-height:100vh">
  ...
  <div class="d-flex flex-grow-1">
    ...
    <main class="p-4 overflow-y-auto flex-grow-1">
      ...
      <h1>Bridges across the Seine at Asnieres</h1>
      ...
      <div class="row g-4 align-items-start mb-4">
        ...
        <div class="col-12 col-md-8">
          <div class="border rounded-1 overflow-hidden">
            <div class="img-card" style="height:500px">
              <img class="art-image" src="{{ asset('images/art/van_gogh/Bridges_across_the_Seine_at_Asnieres.jpg') }}" alt="" style="object-fit:contain"/>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-4 d-flex flex-column gap-4 pt-2">
          <div>
            ...
            <div class="detail-value">Vincent van Gogh</div>
          </div>
          <div>
            <div class="muted-label">DATE</div>
            <div class="detail-value">1887</div>
          </div>
          <div>
            <div class="muted-label">GENRE</div>
            <div class="detail-value">Impressionism</div>
          </div>
          <div>
            <div class="muted-label">PRICE</div>
            <div class="detail-value">879€</div>
          </div>
          <div class="border-top pt-3 d-flex flex-column gap-2">
            <div class="d-flex align-items-center gap-1" style="width: 100px">
              <button class="sm-icon-btn" style="width: 100%">−</button>
              <span class="text-center" style="font-size:16px">1</span>
              <button class="sm-icon-btn" style="width: 100%">+</button>
            </div>
            <div class="d-flex gap-2" style="width: 100px">
              <div class="sm-icon-btn" style="width: 100%"><img src="{{ asset('icons/cart.svg') }}" alt="Add to cart"/></div>
              <div class="sm-icon-btn" style="width: 100%"><img src="{{ asset('icons/bookmark.svg') }}" alt="Save"/></div>
            </div>
            <div class="d-flex">
              <a class="mid-btn" style="border-width:2px; width:100px; height: 28px" href="{{ route('artworks') }}">Go back</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <p style="font-size:18px; color:var(--muted); padding-top:24px">
        A calm riverside scene depicting bridges and reflections in the Seine.
      </p>
    </main>
