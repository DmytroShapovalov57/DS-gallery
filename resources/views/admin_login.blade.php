...
<head>
  ...
  <title>DSgallery: admin_login</title>
...
<body class="d-flex flex-column" style="min-height:100vh">
  ...
  <nav class="navbar px-4 py-2 border-bottom sticky-top bg-white d-flex justify-content-between">
    ...
    <div class="d-flex align-items-center gap-2">
      <span class="mid-btn">admin</span>
      <a class="mid-btn active" href="{{ route('admin.login') }}">Log in</a>
    </div>
  </nav>
  ...
  <div class="d-flex flex-grow-1 justify-content-center p-4">
    <div style="width:100%;max-width:380px">
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="email" placeholder="admin@dsgallery.com"/>
      </div>
      <div class="mb-3">
      ...
      <a class="btn btn-dark w-100 mb-3" href="{{ route('admin.artworks') }}">Log in</a>
