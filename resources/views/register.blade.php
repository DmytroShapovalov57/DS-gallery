...
<body class="d-flex flex-column" style="min-height:100vh">
  ...
  <nav class="navbar px-4 py-2 border-bottom sticky-top bg-white d-flex justify-content-between">
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <a class="mid-btn active" href="{{ route('register') }}">Register</a>
    </div>
  </nav>
  ...
  <div class="d-flex flex-grow-1">
    ...
    <main class="d-flex justify-content-center p-4 flex-grow-1 overflow-y-auto">
      <div style="width:100%;max-width:500px">
        ...
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="row g-3 mb-3">
            <div class="col-6">
              ...
              <input class="form-control" type="text" name="first_name" placeholder="Willem" value="{{ old('first_name') }}"/>
            </div>
            <div class="col-6">
              <label class="form-label small fw-semibold">Last name</label>
              <input class="form-control" type="text" name="last_name" placeholder="Dafoe" value="{{ old('last_name') }}"/>
            </div>
          </div>
          <div class="mb-3">
        ...
        <p class="text-center text-muted small">Already have an account?
